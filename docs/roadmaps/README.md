...
- **Active completion plan:** finish external consumer discovery structural-admission finalization after `1d4487fec60da7cf24567ce74efcaa7b8027500a` by proving rollback/forward-patch atomicity for admitted roots, fixing projection snapshot/final-state plumbing, repairing pending-admission dedupe, completing EF evaluation-closure checks, and closing the remaining regression/release matrix: [Tasks 211–219](../codex-plan-external-consumer-discovery-structural-admission-finalization.md)
