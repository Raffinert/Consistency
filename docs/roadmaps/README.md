...
- **CURRENT API LINE:** `0.2.0-alpha.1` removes the pre-v2 compatibility vocabulary after the v2 production landing; the `0.1.0-rc.1` package and workflow evidence below is historical and does not verify the current head: [API v1 removal plan](../codex-plan-remove-api-v1.md)
