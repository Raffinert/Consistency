...
- **ACTIVE RELEASE-PREP PLAN — Tasks 247–255:** restart all RC verification from the post-DAG baseline `dddb1d819b7136b16061153715b69db63b68bf83`; pre-DAG package, smoke-test, and CI evidence is obsolete. Public publication remains blocked while the repository is private: [Tasks 247–255](../codex-plan-0.1.0-rc.1-release-preparation.md)
