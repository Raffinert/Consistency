...
- Active implementation plan: [Tasks 27–33](../codex-plan-causal-integrity-bootstrap-and-cross-source.md)
...
The active plan is the implementation source of truth. Preserve completed plans and the archive when researching why earlier design decisions were made; use `docs/architecture.md` for the current runtime contracts.
