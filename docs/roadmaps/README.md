...
- **Active completion plan:** finish post-`96c076d` external consumer discovery structural-admission verification and closeout by completing the structural-mutation helper parity, atomicity, admission-identity, EF evaluation-closure, policy/scope, overlay/batching, failure/retry, manual-UoW, documentation, and exact-SHA release gates: [Tasks 220–228](../codex-plan-external-consumer-discovery-post-96c076d-verification-and-closeout.md)
- Tasks 211–219 remain the superseded structural-admission implementation wave; the post-`96c076d` follow-up is the active proof and closeout plan. Do not mark either wave complete until the exact final implementation SHA has successful CI recorded.
