...
- **Active completion plan:** close the verified post-`ccfb24f` external consumer discovery gaps: relation-right coverage-admission dependency snapshot/rebasing, missing EF identity/evaluation-closure proof, exact policy/scope substitution boundaries, ChangeTracker overlay/batching guards, durability/manual-UoW proof, and exact final-SHA release verification: [Tasks 237–243](../codex-plan-external-consumer-discovery-post-ccfb24f-gap-closeout.md)
- Tasks 220–228 were substantially implemented by `e3d050fa0fe6a62422da1ce261f4183bf66e347e` and are present in remote `main` with green CI at `ccfb24fd485488d5680271545232e7ed6f26f031`, but remote review found a remaining relation-right structural dependency snapshot defect plus unproven contract cases. Superseded for active closeout by Tasks 237–243: [Tasks 220–228](../codex-plan-external-consumer-discovery-post-96c076d-verification-and-closeout.md)
- Tasks 211–219 remain the superseded structural-admission implementation wave; the post-`96c076d` follow-up was the broader proof/closeout wave and is now superseded by the narrower post-`ccfb24f` gap plan.
- Tasks 202–210 were **partially implemented** at `1d4487fec60da7cf24567ce74efcaa7b8027500a`; that exact commit has green GitHub Actions CI and correctly separates `CoverageAdmission` from `IAddedMutation`, but it added no regression tests and leaves structural relation/projection patch scope, pending-admission dedupe, generic evaluation closure, and the broader proof matrix incomplete. Superseded by Tasks 211–219: [Tasks 202–210](../codex-plan-external-consumer-discovery-hardening-completion.md)
- Tasks 192–201 were **partially implemented** at `730de44756aeced16af8b7bb011ab9e2ed4e0374`; that exact commit has green GitHub Actions CI and includes useful policy/scope/EF-metadata/materialization-rollback hardening, but it leaves structural `CoverageAdmission` semantics, full evaluation closure, and most required regression proof incomplete. Superseded by Tasks 202–219: [Tasks 192–201](../codex-plan-external-consumer-discovery-hardening-and-proof.md)
- Implemented mutation-driven external consumer discovery for direct reference-navigation dependencies at `b57b4ba98922abbb61c2a86bcdc3b81adf377897`; CI for that implementation commit is green, with later hardening continued by Tasks 192–219: [Tasks 182–191](../codex-plan-external-consumer-discovery-and-incomplete-graph-resolution.md)
