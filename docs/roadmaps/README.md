...
- **Active docs-only closeout plan:** finalize external consumer discovery documentation truthfully without changing production/test behavior: record verified feature baseline `197913a329f6de006798d89b4bfb3eb428de99e9` and exact-head CI run 288 (`35216826855`), mark Tasks 237–243 completed, remove stale active wording, and verify the resulting docs-only head without creating a self-referential SHA loop: [Tasks 244–246](../codex-plan-external-consumer-discovery-final-documentation-closeout.md)
- Tasks 237–243 closed the remaining relation-right structural dependency defect and the previously unproven identity/closure, scope-substitution, ChangeTracker-overlay/batching, durability, retry, cancellation, and manual-UoW contracts. The resulting feature baseline `197913a329f6de006798d89b4bfb3eb428de99e9` has exact-head green CI run 288 (`35216826855`). The remaining work is documentation-only and is governed by Tasks 244–246: [Tasks 237–243](../codex-plan-external-consumer-discovery-post-ccfb24f-gap-closeout.md)
- Tasks 220–228 implemented the broader external-consumer-discovery structural-admission and verification wave at `e3d050fa0fe6a62422da1ce261f4183bf66e347e`, reached remote `main` with green CI at `ccfb24fd485488d5680271545232e7ed6f26f031`, and were followed by the narrower Tasks 237–243 gap closeout: [Tasks 220–228](../codex-plan-external-consumer-discovery-post-96c076d-verification-and-closeout.md)
